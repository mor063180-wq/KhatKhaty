...
import ir.khatkhaty.keyboard.layout.ui.KeyboardLayoutView;
import ir.khatkhaty.keyboard.layout.ui.KeyboardUiFactory;
import ir.khatkhaty.keyboard.theme.ThemeDefinitions;
import ir.khatkhaty.keyboard.theme.ThemeInfo;
    ...
    private ThemeInfo setThemeByIndex(KeyboardPreferences keyboardPreferences, int index) {
        ...
        switch (index) {
            ...
            case 6:
                ...
                break;
            case 7:
                themeInfo = ThemeDefinitions.Midnight();
                break;
            default:
